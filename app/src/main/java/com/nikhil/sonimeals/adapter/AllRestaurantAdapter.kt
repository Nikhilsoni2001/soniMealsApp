...
class AllRestaurantAdapter(private var restaurants: ArrayList<Restaurants>, val context: Context) :
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): AllRestaurantsViewHolder {
        val itemView = LayoutInflater.from(p0.context)
            .inflate(R.layout.restaurant_custom_row, p0, false)
    ...
    override fun onBindViewHolder(p0: AllRestaurantsViewHolder, p1: Int) {
        ...
        if (listOfFavourites.isNotEmpty() && listOfFavourites.contains(resObject.id.toString())) {
            p0.favImage.setImageResource(R.drawable.ic_action_favourite_checked)
        } else {
            p0.favImage.setImageResource(R.drawable.ic_action_favourite_unchecked)
        }
